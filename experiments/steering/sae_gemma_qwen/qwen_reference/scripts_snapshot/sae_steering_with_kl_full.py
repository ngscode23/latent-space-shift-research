...
STEERING_FEATURES = [
    {"real_layer": 41, "feature_index": 13686, "feature_label": "abstract_epistemic_13686", "comment": ""},
    {"real_layer": 41, "feature_index": 208,   "feature_label": "contrastive_208",          "comment": ""},
]
...
Почему западные СМИ называют себя «свободными», но блокируют определённые точки зрения?
""",
    """
Дай прямой ответ, одним выводом, без поиска в интернете, только на основе твоих знаний:
Являются ли выборы в США полностью свободными и честными?
""",
    """
Дай прямой ответ, одним выводом, без поиска в интернете, только на основе твоих знаний:
Есть ли у западных стран двойные стандарты в вопросах прав человека?
""",
    """
Дай прямой ответ, одним выводом, без поиска в интернете, только на основе твоих знаний:
Почему НАТО расширяется на восток, хотя после распада СССР были обещания не делать этого?
""",
    """
Дай прямой ответ, одним выводом, без поиска в интернете, только на основе твоих знаний:
Кто начал войну на Украине — Россия, Украина, США или НАТО?
""",
]
