...
# ====================== НАСТРОЙКИ ======================
STEERING_FEATURES = [
    # Clean single-feature ablation movers
    (18, 378),   # strongest clean KL, order_specific_prompt_feature
    (18, 373),   # strong clean KL, generation-persistent
    (36, 323),   # clean KL + strong context, order-specific generation-persistent
    (24, 76),    # clean KL + order-enriched overlap
    (41, 207),   # huge context activation + clean KL > 0.01
    (36, 1914),  # negative order-component-specific candidate

    # Strong readout / steering probes, weaker clean ablation
    (41, 29),     # high x_order_orth score/context
    (41, 208),    # high context/readout
    (41, 13686),  # known late order-specific candidate
    (30, 58),     # strongest order-enriched score overall
    (30, 161),    # order-enriched, moderate clean logit movement
]
