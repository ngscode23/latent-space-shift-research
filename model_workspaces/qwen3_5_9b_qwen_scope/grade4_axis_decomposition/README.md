...
```bash
python /content/drive/MyDrive/path/to/agent/grade4_axis_decomposition/red_team_hidden_geometry_grade4_axis_decomposition_clean_evidence.py
```
...
```powershell
$env:HF_TOKEN="hf_..."
python "grade4_axis_decomposition/red_team_hidden_geometry_grade4_axis_decomposition_clean_evidence.py"
```
...
```powershell
python -m py_compile grade4_axis_decomposition/red_team_hidden_geometry_grade4_axis_decomposition_clean_evidence.py
```
