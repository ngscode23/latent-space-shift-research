...
RESULTS_DIR = Path("red_team_hidden_geometry_results_qwen35_9b_full_mechanistic_01")
...
CAUSAL_ALPHA_VALUES = [0.25, 0.5, 1.0]
...
BEHAVIORAL_CONTROL_ALPHA_VALUES = [0.25, 0.5, 0.75, 1.0]
BEHAVIORAL_CONTROL_PRIMARY_ALPHA = 0.5  # Primary non-degenerate comparison point.
